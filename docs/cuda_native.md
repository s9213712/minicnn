...
- `performance_report.runtime.hotspots` now records a representative traced forward-pass hotspot summary (`top_nodes`, `top_ops`, `top_categories`) and includes per-op call counts / average time
