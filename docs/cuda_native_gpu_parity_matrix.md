...
|---|---|---|---|
| `Linear` | `native_gpu_linear_training_step` | Hermetic reference math for CE/MSE/BCE | Pending real GPU run |
| `Flatten -> Linear` | `native_gpu_linear_training_step` | Hermetic reference math for CE/MSE/BCE | Pending real GPU run |
