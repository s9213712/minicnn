...
GPU_KERNEL_BOOTSTRAP_SPECS: tuple[GpuKernelSpec, ...] = (
    ...
    GpuKernelSpec('AdaptiveAvgPool2d', 'pool', 'global_avgpool2d_nchw', 1, 1, tuple(), 'NCHW', 'partial_native', 'planned'),
    GpuKernelSpec('DepthwiseConv2d', 'conv', 'depthwise_conv2d_nchw', 1, 1, ('weight', 'bias'), 'NCHW', 'partial_native', 'planned'),
    ...
    GpuKernelSpec('GELU', 'activation', 'elementwise_unary', 1, 1, tuple(), 'match_input', 'partial_native', 'planned'),
    GpuKernelSpec('GlobalAvgPool2d', 'pool', 'global_avgpool2d_nchw', 1, 1, tuple(), 'NCHW', 'partial_native', 'planned'),
    GpuKernelSpec('GroupNorm', 'normalization', 'groupnorm_nchw', 1, 1, ('weight', 'bias'), 'NCHW', 'partial_native', 'planned'),
    GpuKernelSpec('Identity', 'shape', 'identity_alias', 1, 1, tuple(), 'match_input', 'native_alias', 'not_needed'),
    GpuKernelSpec('LayerNorm2d', 'normalization', 'layernorm2d_nchw', 1, 1, ('weight', 'bias'), 'NCHW', 'partial_native', 'planned'),
    ...
    GpuKernelSpec('PointwiseConv2d', 'conv', 'conv2d_nchw', 1, 1, ('weight', 'bias'), 'NCHW', 'partial_native', 'planned'),
    GpuKernelSpec('ReLU', 'activation', 'elementwise_unary', 1, 1, tuple(), 'match_input', 'native_forward', 'partial_native'),
    GpuKernelSpec('Sigmoid', 'activation', 'elementwise_unary', 1, 1, tuple(), 'match_input', 'partial_native', 'planned'),
    GpuKernelSpec('SiLU', 'activation', 'elementwise_unary', 1, 1, tuple(), 'match_input', 'partial_native', 'planned'),
    GpuKernelSpec('Tanh', 'activation', 'elementwise_unary', 1, 1, tuple(), 'match_input', 'partial_native', 'planned'),
)
