...
CUDA_NATIVE_CAPABILITIES: dict[str, object] = {
    ...
    'notes': [
        ...
        'gpu_native Linear subsets support native global-norm gradient clipping; Conv-family subsets still require optimizer.grad_clip_global=0.0 until multi-node reduction support lands.',
