...
CUDA_NATIVE_CAPABILITIES: dict[str, object] = {
    ...
    'notes': [
        ...
        'DepthwiseConv2d, PointwiseConv2d, LayerNorm2d, GELU, and global pooling use numpy reference kernels.',
        'ResidualBlock, ConvNeXtBlock, and Dropout run through experimental composite numpy reference kernels.',
